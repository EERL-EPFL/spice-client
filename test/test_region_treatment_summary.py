...
class TestRegionTreatmentSummary(unittest.TestCase):
    """RegionTreatmentSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RegionTreatmentSummary:
        """Test RegionTreatmentSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RegionTreatmentSummary`
        """
        model = RegionTreatmentSummary()
        if include_optional:
            return RegionTreatmentSummary(
    ...
    def testRegionTreatmentSummary(self):
        """Test RegionTreatmentSummary"""
